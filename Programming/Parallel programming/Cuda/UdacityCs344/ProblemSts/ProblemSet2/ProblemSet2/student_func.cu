                                ...
                                const float* const h_filter, const size_t filterWidth)
{
  ...
  // Tamanho de um Unsigned char, vezes o tamanho do filtro, ou seja, 9*9 variaveis unsigned char
                        ...
                        const int filterWidth)
{
  ...
  const int gridSizeX = ceil(double(numCols) / double(blockSize.x));
  const int gridSizeY = ceil(double(numRows) / double(blockSize.y));
