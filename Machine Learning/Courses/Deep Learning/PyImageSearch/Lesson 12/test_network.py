...
model_input_path = "output/simple_neural_network.hdf5"
test_mgs_path = "test_images"
...
print("[INFO] testing on images in {}".format(test_mgs_path))

# loop over our testing images
for imagePath in paths.list_images(test_mgs_path):
